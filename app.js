...
const APP_VERSION = "v2.10.0 (2569-09-25)"; // อัปเดตเลขนี้ทุกครั้งที่มีการแก้ไข/เพิ่มแบบประกันใหม่ เพื่อให้รู้ว่าไฟล์ที่ใช้อยู่เป็นเวอร์ชันล่าสุดหรือไม่
...
const UNJAI_FEMALE = [
    [1532, 2264, 2996, 3728, 4460, 6290, 8120],
    [1569, 2322, 3075, 3828, 4581, 6464, 8346],
    [1607, 2382, 3157, 3932, 4707, 6645, 8582],
    [1646, 2443, 3240, 4037, 4834, 6827, 8819],
    [1686, 2506, 3326, 4146, 4966, 7016, 9066],
    [1728, 2572, 3416, 4260, 5104, 7214, 9324],
    [1773, 2643, 3513, 4383, 5254, 7428, 9603],
    [1819, 2715, 3611, 4507, 5403, 7643, 9883],
    [1868, 2792, 3716, 4640, 5564, 7874, 10184],
    [1918, 2871, 3824, 4777, 5730, 8113, 10495],
    [1970, 2953, 3936, 4919, 5902, 8360, 10817],
    [2026, 3041, 4054, 5071, 6086, 8624, 11161],
    [2083, 3131, 4179, 5227, 6275, 8896, 11515],
    [2143, 3226, 4309, 5392, 6475, 9183, 11890],
    [2206, 3325, 4444, 5563, 6682, 9480, 12277],
    [2272, 3429, 4586, 5743, 6900, 9793, 12685],
    [2340, 3536, 4732, 5928, 7124, 10114, 13104],
    [2412, 3649, 4886, 6123, 7360, 10453, 13545],
    [2487, 3767, 5047, 6327, 7607, 10807, 14007],
    [2565, 3890, 5215, 6540, 7865, 11178, 14490],
    [2646, 4017, 5388, 6759, 8130, 11558, 14985],
    [2731, 4149, 5567, 6985, 8403, 11948, 15493],
    [2819, 4286, 5753, 7220, 8687, 12355, 16022],
    [2912, 4431, 5950, 7469, 8988, 12786, 16583],
    [3008, 4580, 6152, 7724, 9296, 13226, 17156],
    [3107, 4735, 6359, 7985, 9611, 13676, 17741],
    [3213, 4896, 6579, 8262, 9945, 14153, 18360],
    [3321, 5062, 6803, 8544, 10285, 14638, 18990],
    [3437, 5240, 7043, 8846, 10649, 15157, 19664],
    [3556, 5421, 7286, 9151, 11016, 15679, 20341],
    [3682, 5612, 7542, 9472, 11402, 16227, 21052],
    [3814, 5811, 7808, 9805, 11802, 16795, 21787],
    [3952, 6019, 8086, 10153, 12220, 17388, 22555],
    [4099, 6239, 8379, 10519, 12659, 18009, 23359],
    [4252, 6467, 8682, 10897, 13112, 18650, 24187],
    [4415, 6710, 9005, 11300, 13592, 19333, 25070],
    [4588, 6966, 9344, 11722, 14100, 20045, 25991],
    [4772, 7238, 9704, 12170, 14636, 20801, 26966],
    [4969, 7529, 10089, 12649, 15209, 21609, 28009],
    [5179, 7838, 10497, 13156, 15815, 22463, 29110],
    [5406, 8172, 10938, 13704, 16470, 23385, 30300],
    [5649, 8529, 11409, 14289, 17169, 24369, 31569],
    [5912, 8915, 11918, 14921, 17924, 25432, 32939],
    [6199, 9336, 12473, 15610, 18747, 26590, 34432],
    [6511, 9795, 13079, 16363, 19647, 27857, 36067],
    [6854, 10300, 13746, 17192, 20636, 29253, 37868],
    [7230, 10855, 14480, 18105, 21730, 30793, 39855],
    [7639, 11457, 15275, 19093, 22911, 32456, 42001],
    [8082, 12107, 16132, 20157, 24182, 34245, 44307],
    [8566, 12816, 17066, 21315, 25566, 36191, 46816],
    [9096, 13592, 18088, 22584, 27080, 38320, 49560],
    [9680, 14448, 19216, 23984, 28752, 40672, 52592],
    [10314, 15373, 20432, 25491, 30550, 43198, 55845],
    [11006, 16379, 21752, 27125, 32498, 45931, 59363],
    [11760, 17469, 23178, 28887, 34596, 48869, 63141],
    [12493, 18563, 24633, 30703, 36773, 51948, 67123],
];
const UNJAI_MALE = [
    [1525, 2145, 2765, 3385, 4005, 5555, 7105],
    [1561, 2199, 2837, 3475, 4113, 5708, 7303],
    [1599, 2256, 2913, 3570, 4227, 5870, 7512],
    [1637, 2313, 2989, 3665, 4341, 6031, 7721],
    [1679, 2376, 3073, 3770, 4467, 6210, 7952],
    [1721, 2439, 3157, 3875, 4593, 6388, 8183],
    [1766, 2507, 3248, 3989, 4730, 6583, 8435],
    [1812, 2576, 3340, 4104, 4868, 6778, 8688],
    [1861, 2650, 3439, 4228, 5017, 6990, 8962],
    [1912, 2727, 3542, 4357, 5172, 7210, 9247],
    [1966, 2808, 3650, 4492, 5334, 7439, 9544],
    [2021, 2891, 3761, 4631, 5501, 7676, 9851],
    [2079, 2978, 3877, 4776, 5675, 7923, 10170],
    [2141, 3072, 4003, 4934, 5865, 8193, 10520],
    [2205, 3168, 4131, 5094, 6057, 8465, 10872],
    [2272, 3269, 4266, 5263, 6260, 8753, 11245],
    [2341, 3373, 4405, 5437, 6469, 9049, 11629],
    [2414, 3483, 4552, 5621, 6690, 9363, 12035],
    [2491, 3599, 4707, 5815, 6923, 9693, 12463],
    [2571, 3719, 4867, 6015, 7163, 10033, 12903],
    [2655, 3845, 5035, 6225, 7415, 10390, 13365],
    [2742, 3975, 5208, 6441, 7674, 10757, 13839],
    [2832, 4109, 5386, 6663, 7940, 11133, 14325],
    [2928, 4252, 5576, 6900, 8224, 11534, 14844],
    [3027, 4399, 5771, 7143, 8515, 11945, 15375],
    [3131, 4552, 5973, 7394, 8815, 12368, 15920],
    [3239, 4711, 6183, 7656, 9127, 12807, 16487],
    [3354, 4880, 6406, 7932, 9458, 13273, 17088],
    [3473, 5054, 6635, 8216, 9797, 13750, 17702],
    [3598, 5236, 6874, 8512, 10150, 14245, 18340],
    [3728, 5425, 7122, 8819, 10516, 14759, 19001],
    [3865, 5622, 7379, 9136, 10893, 15286, 19678],
    [4009, 5829, 7649, 9469, 11289, 15839, 20389],
    [4162, 6048, 7934, 9820, 11706, 16421, 21136],
    [4322, 6276, 8230, 10184, 12138, 17023, 21908],
    [4492, 6517, 8542, 10567, 12592, 17655, 22717],
    [4674, 6775, 8876, 10977, 13078, 18331, 23583],
    [4866, 7046, 9226, 11406, 13586, 19036, 24486],
    [5073, 7338, 9603, 11868, 14133, 19796, 25458],
    [5295, 7650, 10005, 12360, 14715, 20603, 26490],
    [5533, 7986, 10437, 12889, 15341, 21471, 27601],
    [5789, 8345, 10901, 13457, 16013, 22403, 28793],
    [6066, 8734, 11402, 14070, 16738, 23408, 30078],
    [6368, 9160, 11953, 14744, 17536, 24516, 31496],
    [6696, 9623, 12550, 15477, 18404, 25722, 33039],
    [7056, 10133, 13210, 16287, 19364, 27057, 34749],
    [7451, 10696, 13941, 17186, 20431, 28544, 36656],
    [7879, 11304, 14729, 18154, 21579, 30145, 38704],
    [8343, 11962, 15581, 19200, 22819, 31867, 40914],
    [8849, 12679, 16509, 20339, 24169, 33744, 43319],
    [9404, 13466, 17528, 21590, 25652, 35807, 45962],
    [10014, 14334, 18654, 22974, 27294, 38094, 48894],
    [10679, 15277, 19875, 24473, 29071, 40566, 52061],
    [11401, 16298, 21195, 26092, 30989, 43232, 55474],
    [12189, 17409, 22629, 27849, 33069, 46119, 59169],
    [12932, 18500, 24068, 29636, 35204, 49124, 63044],
];
...
// ส่วนลดอัตราเบี้ยรายปีต่อทุน 1,000 บาท แยกตามระยะชำระเบี้ย 5/10/15 ปี (คู่มือ V.14)
const happywlDiscount = (si, term) => {
    const col = { 5: 0, 10: 1, 15: 2 }[term];
    if (col === undefined) return 0;
    if (si >= 50000000) return [3, 1, 1][col];
    if (si >= 30000000) return [2, 0.5, 0.5][col];
    if (si >= 10000000) return [1, 0.25, 0.25][col];
    return 0;
};
// ดัชนีแถว = อายุ (0-65)
...
// ส่วนลดอัตราเบี้ยรายปีต่อทุน 1,000 บาท แยกตามระยะชำระเบี้ย 5/10/15/20 ปี (คู่มือ V.14)
const hrpdivDiscount = (si, term) => {
    const col = { 5: 0, 10: 1, 15: 2, 20: 3 }[term];
    if (col === undefined) return 0;
    if (si >= 1000000) return [7, 5.5, 5.25, 5][col];
    if (si >= 500000) return [5, 3.5, 3.25, 3][col];
    if (si >= 300000) return [3, 2.5, 2.25, 2][col];
    if (si >= 200000) return [2, 1.5, 1.25, 1][col];
    return 0;
};
...
const HRP9901_MALE = [269.99, 274.43, 280.01, 285.72, 291.56, 297.54, 303.66, 309.92, 316.33, 322.87, 329.59, 336.44, 343.36, 350.35, 357.38, 364.45, 371.55, 378.7, 385.91, 393.19, 400.56, 408.04, 415.64, 423.39, 431.29, 439.36, 447.6, 456.01, 464.61, 473.39, 482.35, 491.49, 500.8, 510.27, 519.92, 529.73, 539.7, 549.83, 560.13, 570.59, 581.22, 592.01, 602.96, 614.07, 625.34, 636.76, 648.33, 660.04, 671.89, 683.87, 695.99, 708.23, 720.61, 733.11, 745.73, 758.48, 771.34, 784.3, 797.35, 810.48, 823.65, 836.86, 850.09, 863.3, 876.47, 889.58, 902.61, 915.52, 928.28, 940.86, 953.22];
...
// 25) บีแอลเอ เซฟวิ่ง 168 (รบข.24/2569) — อายุรับประกัน 0-83 ปี คุ้มครอง 16 ปี ชำระเบี้ย 8 ปี ทุนขั้นต่ำ 100,000 บาท เบี้ยคงที่ 978/1000 ทุกอายุทุกเพศ
const BLASAVE168_MIN_AGE = 0, BLASAVE168_MAX_AGE = 83, BLASAVE168_MIN_SI = 100000, BLASAVE168_RATE = 978;
const blasave168Discount = (si, age) => {
    if (age > 80)
        return 0;
    if (si >= 3000000)
        return 78;
...
// ปีกรมธรรม์ที่ 1-16: [% เสียชีวิต, % เงินคืนรายปีการันตี] — ปีที่16 รวมเงินคืนครบกำหนด 680%+พิเศษ128%=808%
const BLASAVE168_SCHEDULE = [
    [100, 8], [200, 8], [300, 8], [400, 8], [500, 8], [600, 8], [700, 8], [800, 8], [800, 8], [800, 8],
...
const PENSION888_FIRST_PENSION_PCT = 0.30, PENSION888_ANNUAL_PENSION_PCT = 0.08; // งวดแรกอายุครบ 60 = 30% งวดต่อไปอายุ 61-88 = 8%/ปี
// ดัชนีแถว = อายุ (20-52), แต่ละแถว = [เพศหญิง, เพศชาย]
const PENSION888_FEMALE = [98.95, 103.23, 106.54, 109.75, 112.75, 115.96, 119.27, 122.44, 125.64, 129.19, 132.54, 135.96, 139.65, 143.43, 147.13, 151.03, 154.97, 159.13, 163.25, 167.70, 172.00, 177.26, 183.09, 187.60, 192.52, 197.70, 203.56, 209.21, 214.70, 220.53, 229.69, 235.97, 244.00];
...
const HAPPYPENSION_MALE = [
    [1.36, 358.03, 182.41, 59.92],
    [1.38, 366.91, 186.95, 62.45],
    [1.4, 376.05, 191.62, 65.13],
    [1.42, 385.45, 196.42, 67.98],
    [1.44, 395.1, 201.36, 71],
    [1.47, 405.08, 206.5, 74.21],
    [1.49, 415.42, 211.77, 77.65],
    [1.52, 426.05, 217.2, 81.33],
    [1.54, 436.99, 222.83, 85.26],
    [1.57, 448.36, 228.66, 89.47],
    [1.59, 460.13, 234.66, 94],
    [1.62, 472.24, 240.85, 98.89],
    [1.65, 484.78, 247.32, 104.17],
    [1.68, 497.85, 253.99, 109.86],
    [1.72, 511.32, 260.86, 116.05],
    [1.75, 525.29, 268.08, 122.81],
    [1.78, 539.88, 275.51, 130.17],
    [1.82, 554.92, 283.24, 138.23],
    [1.86, 570.66, 291.32, 147.11],
    [1.9, 587.03, 299.65, 156.93],
    [1.94, 604.02, 308.46, 167.81],
    [1.98, 621.91, 317.56, 179.93],
    [2.03, 640.41, 327.16, 193.57],
    [2.08, 660.08, 337.15, 208.93],
    [2.13, 680.44, 347.73, 226.38],
    [2.18, 702.19, 358.75, 246.44],
    [2.23, 724.88, 370.53, 269.55],
    [2.29, 749.07, 382.89, 296.62],
    [2.36, 774.73, 392.12, 328.62],
    [2.42, 785.87, 401.99, 367.01],
    [2.5, 806.4, null, 413.95],
    [null, 832.85, null, 472.49],
    [null, 866.04, null, 547.49],
    [null, 902.41, null, 647.21],
    [null, 942.78, null, 785.85],
    [null, null, null, 992.16],
];
...
const solveSIFromPremium = (premium, effRate) => {
    ...
    const base = (premium * 1000) / effRate(0);
    let best = 0;
    for (let k = 0; k <= 200; k++) {
        const r = effRate(base * (1 + k * 0.0025));
        const si = (premium * 1000) / r;
        if (Math.abs(effRate(si) - r) < 1e-9 && si > best)
            best = si;
    }
    return best || base;
};
...
function App() {
    ...
    const csForbiddenMainId = CS_FORBIDDEN_MAIN_IDS.find((id) => selected[id]) || null;
    const csDisabled = age > 14 || !!csForbiddenMainId;
    // คช. ภาคบังคับ: ผู้เยาว์ 0-14 ปี กับแบบที่กำหนด (ห่วงรัก 99/20 เฉพาะอายุ 0-4 ปี)
    const csRequiredMainId = age > 14 ? null : (CS_REQUIRED_MAIN_IDS.find((id) => selected[id]) || (selected.HRP9920 && age <= 4 ? "HRP9920" : null));
    const csRequired = !!csRequiredMainId && !csDisabled;
    // งวดชำระที่แบบประกันหลักที่เลือกอยู่อนุญาต
    const selectedMainId = MAIN_IDS.find((m) => selected[m]) || null;
    const isSinglePremiumMain = (id) => SINGLE_PREMIUM_MAIN_IDS.includes(id) || (id === "HAPPYPENSION" && happypensionTerm === "once");
    const allowedPayModes = !selectedMainId ? PAY_MODE.map((m) => m.key)
        : (ANNUAL_ONLY_MAIN_IDS.includes(selectedMainId) || isSinglePremiumMain(selectedMainId)) ? ["year"]
            : YEAR_OR_MONTH_MAIN_IDS.includes(selectedMainId) ? ["year", "month"]
                : PAY_MODE.map((m) => m.key);
    const payModeNote = !selectedMainId ? ""
        : isSinglePremiumMain(selectedMainId) ? "แบบหลักชำระเบี้ยครั้งเดียว (สัญญาเพิ่มเติมชำระรายปี)"
            : ANNUAL_ONLY_MAIN_IDS.includes(selectedMainId) ? "แบบหลักนี้ชำระเบี้ยรายปีเท่านั้น"
                : YEAR_OR_MONTH_MAIN_IDS.includes(selectedMainId) ? "แบบหลักนี้ชำระรายปีหรือรายเดือนเท่านั้น" : "";
    useEffect(() => {
        if (!allowedPayModes.includes(payMode))
            setPayMode("year");
    }, [allowedPayModes.join(","), payMode]);
    ...
    function riderDisabled(p) {
        if (selected.CANCERMAX || NO_RIDER_MAIN_IDS.some((id) => selected[id]))
    ...
    function savingsSIFromPremium(id, premium) {
        ...
        if (id === "PSAVE104") {
            return Math.floor(solveSIFromPremium(adjPremium, (s) => PSAVE104_RATE - psave104Discount(s)));
        }
        if (id === "PSAVE126") {
    ...
    function mainSIOf(id) {
        switch (id) {
            ...
            case "LIFE99": return life99SI;
            case "UNJAI": return UNJAI_LIFE_SI;
            case "PLUS2": return plus2SI;
            case "PRESTIGE": return prestigeSI;
            case "HAPPYPENSION": return happypensionTerm ? happypensionRow(happypensionTerm).effectiveSI : 0;
            case "HAPPYWL": return happywlSI;
            case "HRP9920": return hrp9920SI;
            case "HRPDIV": return hrpdivSI;
            case "HRP9901": return hrp9901SI;
    ...
    function productDisabled(p) {
        if (p.id === "CS")
            return csDisabled || NO_RIDER_MAIN_IDS.some((id) => selected[id]);
        if (p.isMain)
    ...
    }, [selected.UNJAI, selected.PSAVE104, selected.PSAVE126]);
    ...
    function calcCS() {
        ...
        if (csForbiddenMainId)
            return { ok: false, msg: `แบบ ${PRODUCTS.find((x) => x.id === csForbiddenMainId).name} ไม่อนุญาตให้ผู้เยาว์ซื้อ คช.` };
        ...
        // 1) ระยะเวลาชำระเบี้ยของกรมธรรม์หลักที่เลือกอยู่
        // 2) 21 - อายุผู้เยาว์  3) 65 - อายุผู้ปกครอง
        const termMain = selectedMainId ? mainPolicyPaymentYears(selectedMainId) : 0;
        if (!termMain)
            return { ok: false, msg: "กรุณาเลือกแบบประกันหลักและระยะชำระเบี้ยก่อน (ระยะคุ้มครอง คช. อิงระยะชำระเบี้ยของแบบหลัก)" };
    ...
    function calcHAPPYWL() {
        ...
        return { ok: true, premium, benefits: [
                ...
                ["ส่วนลดอัตราเบี้ย", disc > 0 ? disc + " บาท ต่อทุน 1,000 บาท" : "ไม่มี"],
    ...
    function buildSavingsSchedule(id) {
        ...
        const yearlyPremium = Math.round(getDisplayPremium(id, (rate * si) / 1000));
        let cumPremiumS = 0;
        const deathMaxPrem = DEATH_MAX_PREMIUM_IDS.includes(id);
        const rows = scheduleDef.map(([deathPct, cashPct], i) => {
            const year = i + 1;
            const isLastYear = year === scheduleDef.length;
            const premiumThisYear = year <= payYears ? yearlyPremium : 0;
            cumPremiumS += premiumThisYear;
            return {
                year, age: age + i,
                premium: premiumThisYear,
                cashPct, cashBaht: Math.round(si * (cashPct / 100)),
                coverageBaht: Math.round(deathMaxPrem ? Math.max(si * (deathPct / 100), cumPremiumS) : si * (deathPct / 100)),
    ...
    function buildPensionSchedule(id) {
        ...
        if (id === "HAPPYPENSION") {
            ...
            if (!row.ok)
                return { rows: [], breakEvenAge: null };
            const payYears = happypensionTerm === "once" ? 1 : happypensionTerm === "5y" ? 5 : happypensionTerm === "10y" ? 10 : (60 - age);
            const rows = [];
            let cumPremium = 0, cumPension = 0, breakEvenAge = null;
            for (let a = age; a <= 98; a++) {
                const premium = a < age + payYears ? Math.round(row.premium) : 0;
                cumPremium += premium;
                const pension = a >= 60 ? Math.round(row.pension) : 0;
                cumPension += pension;
                if (breakEvenAge === null && cumPremium > 0 && cumPension >= cumPremium)
                    breakEvenAge = a;
    ...
    // คำนวณ IRR ของแบบบำนาญ โดยตัดกระแสเงินสดที่อายุที่เลือกเป็นจุดสิ้นสุด (TVM: เบี้ยจ่ายต้นปี บำนาญรับปลายปี)
    function computePensionIRRUpToAge(id, targetAge) {
        const { rows } = buildPensionSchedule(id);
        const relevant = rows.filter((r) => r.age <= targetAge);
        if (relevant.length === 0)
            return null;
        const startAge = relevant[0].age;
        const totalYears = targetAge - startAge + 1;
        const cf = new Array(totalYears + 1).fill(0);
        relevant.forEach((r) => {
            const t = r.age - startAge;
            if (r.premium > 0)
                cf[t] -= r.premium;
            cf[t] += r.pension; // บำนาญจ่าย ณ วันครบรอบปีกรมธรรม์ที่อายุครบตามแถว (ต้นปีของแถวนั้น)
        });
        return calcIRR(cf);
    }
    ...
    function handleCalculate() {
        ...
        const mode = allowedPayModes.includes(payMode) ? payMode : "year";
        const modeDef = PAY_MODE.find((m) => m.key === mode);
        cards.forEach((c) => {
            ...
            React.createElement("main", { className: "max-w-5xl mx-auto px-5 py-6 space-y-6" },
                ...
                React.createElement("section", { className: "rounded-2xl p-5", style: { background: BRAND.card, boxShadow: "0 6px 24px rgba(11,42,85,0.07)" } },
                    ...
                    React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-4" },
                        ...
                        React.createElement(Field, { label: "\u0E07\u0E27\u0E14\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E1A\u0E35\u0E49\u0E22" },
                            React.createElement("select", { value: allowedPayModes.includes(payMode) ? payMode : "year", onChange: (e) => setPayMode(e.target.value), className: "w-full rounded-xl border px-3 py-2.5 text-[24px]", style: { borderColor: "#D7E8F0" } }, PAY_MODE.map((m) => React.createElement("option", { key: m.key, value: m.key, disabled: !allowedPayModes.includes(m.key) }, m.label + (allowedPayModes.includes(m.key) ? "" : " (ไม่รองรับ)")))),
                            payModeNote && React.createElement("p", { className: "text-[16px] mt-1", style: { color: BRAND.sub } }, payModeNote)))),
                age >= 0 && age <= 14 && (() => {
                    const csProduct = PRODUCTS.find((p) => p.id === "CS");
                    const csMandatory = csRequired;
                    return (React.createElement("section", { className: "rounded-2xl p-5", style: { background: "#FFF9EE", boxShadow: "0 6px 24px rgba(11,42,85,0.07)", border: "1.5px solid #F3D98B" } },
                        ...
                        React.createElement("p", { className: "text-[21px] mb-3", style: { color: BRAND.sub } }, csForbiddenMainId
                            ? `แบบ ${PRODUCTS.find((x) => x.id === csForbiddenMainId).name} ไม่อนุญาตให้ผู้เยาว์ซื้อ คช.`
                            : csMandatory
                            ? `แบบ ${(PRODUCTS.find((x) => x.id === csRequiredMainId) || {}).name} กำหนดให้ผู้เยาว์ต้องซื้อ คช. ด้วย ระบบติ๊กเลือกให้อัตโนมัติแล้ว`
                        ...
                        React.createElement(ProductRow, { product: csProduct, checked: selected.CS, onToggle: () => toggle("CS"), age: age, live: liveResults.CS, pending: PRIMARY_FIELD_ZERO.CS, disabled: csDisabled || NO_RIDER_MAIN_IDS.some((id) => selected[id]), recommended: false, expanded: !!openProductCards.CS, onToggleExpand: () => toggleProductCard("CS") }, renderProductChildren(csProduct))));
                })(),
                React.createElement("section", { className: "rounded-2xl p-5", style: { background: BRAND.card, boxShadow: "0 6px 24px rgba(11,42,85,0.07)" } },
                    ...
                    React.createElement("div", { className: "flex flex-wrap gap-2" },
                        ...
                        React.createElement("button", { onClick: () => setSavingsGroupOpen((o) => { const next = !o; if (next)
                                setPensionGroupOpen(false); return next; }), className: "flex items-center gap-1.5 text-[21px] font-medium px-3.5 py-2.5 rounded-full border", style: { borderColor: savingsGroupOpen ? BRAND.green : "#D7E8F0", background: savingsGroupOpen ? "#F0FAE6" : "#fff", color: savingsGroupOpen ? BRAND.greenDeep : BRAND.navy } },
                            React.createElement("span", null, "\uD83D\uDCB0"),
                            " \u0E1B\u0E23\u0E30\u0E01\u0E31\u0E19\u0E2A\u0E30\u0E2A\u0E21\u0E17\u0E23\u0E31\u0E1E\u0E22\u0E4C"),
                        React.createElement("button", { onClick: () => setPensionGroupOpen((o) => { const next = !o; if (next)
                                setSavingsGroupOpen(false); return next; }), className: "flex items-center gap-1.5 text-[21px] font-medium px-3.5 py-2.5 rounded-full border", style: { borderColor: pensionGroupOpen ? BRAND.green : "#D7E8F0", background: pensionGroupOpen ? "#F0FAE6" : "#fff", color: pensionGroupOpen ? BRAND.greenDeep : BRAND.navy } },
                ...
                result && (React.createElement("section", { className: "space-y-4" },
                    React.createElement("div", { className: "rounded-2xl p-5 text-white", style: { background: `linear-gradient(120deg, ${BRAND.green}, ${BRAND.greenDeep})` } },
                        ...
                        result.singleNote && React.createElement("p", { className: "text-[21px] mt-1 opacity-90" }, result.singleNote),
                    ...
                    React.createElement("div", { className: "grid sm:grid-cols-2 gap-4" }, result.cards.map((c) => (React.createElement("div", { key: c.id, className: "rounded-2xl overflow-hidden", style: { background: BRAND.card, boxShadow: "0 6px 20px rgba(11,42,85,0.08)", borderTop: `4px solid ${BRAND.sky}`, position: "relative" } },
                        ...
                        React.createElement("div", { className: "p-5" },
                            ...
                            React.createElement("p", { className: "text-[45px] font-bold mt-3", style: { color: BRAND.dataBlack } }, baht(c.premium * (c.factor !== undefined ? c.factor : result.factor)) + (c.single ? " (ชำระครั้งเดียว)" : (c.factor !== undefined ? c.factor : result.factor) === 1 ? " / ปี" : "")),
...
// รวมแถวที่ติดกันและมีค่าตามฟิลด์ที่กำหนดเหมือนกันทุกตัว ให้เป็นแถวเดียวแบบช่วงอายุ — ไม่รวมแถวที่มีหมายเหตุหรือเข้าเงื่อนไข forceBreak (เพื่อไม่ให้ปีสำคัญหายไป)
// มุมมองสำหรับพิมพ์/บันทึกเป็น PDF — ใช้สีเดียวกับตารางบนหน้าจอทุกจุด (บังคับคงสีด้วย CSS print-color-adjust)
function PrintTableView({ data }) {
    if (!data)
        return null;
    ...
    if (data.type === "pension") {
        const { title, rows, breakEvenAge } = data;
        return (React.createElement("div", null,
            React.createElement("h2", { style: { fontSize: 20, fontWeight: 700, color: BRAND.navy, marginBottom: 10 } }, title),
            React.createElement("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 13 } },
                React.createElement("thead", { style: { background: BRAND.bg } },
                    React.createElement("tr", null,
                        React.createElement("th", { style: { textAlign: "center", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E2D\u0E32\u0E22\u0E38"),
                        React.createElement("th", { style: { textAlign: "right", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E40\u0E1A\u0E35\u0E49\u0E22\u0E15\u0E48\u0E2D\u0E1B\u0E35"),
                        React.createElement("th", { style: { textAlign: "right", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E1A\u0E33\u0E19\u0E32\u0E0D\u0E15\u0E48\u0E2D\u0E1B\u0E35"),
                        React.createElement("th", { style: { textAlign: "right", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E40\u0E1A\u0E35\u0E49\u0E22\u0E2A\u0E30\u0E2A\u0E21"),
                        React.createElement("th", { style: { textAlign: "right", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E1A\u0E33\u0E19\u0E32\u0E0D\u0E2A\u0E30\u0E2A\u0E21"),
                        React.createElement("th", { style: { textAlign: "right", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E01\u0E23\u0E13\u0E35\u0E40\u0E2A\u0E35\u0E22\u0E0A\u0E35\u0E27\u0E34\u0E15"),
                        React.createElement("th", { style: { textAlign: "left", padding: 6, color: BRAND.navy, border: "1px solid #D7E8F0" } }, "\u0E2B\u0E21\u0E32\u0E22\u0E40\u0E2B\u0E15\u0E38"))),
                React.createElement("tbody", null, rows.map((r) => {
                    const isBreakEven = r.age === breakEvenAge;
                    return (React.createElement("tr", { key: r.age, style: { background: isBreakEven ? "#F3FBEF" : "transparent" } },
                        React.createElement("td", { style: { textAlign: "center", padding: 6, color: isBreakEven ? BRAND.greenDeep : BRAND.dataBlack, fontWeight: isBreakEven ? 700 : 400, border: "1px solid #EEF3F7" } }, r.isRange ? `${r.age}-${r.ageEnd}` : r.age),
                        React.createElement("td", { style: { textAlign: "right", padding: 6, color: BRAND.dataBlack, border: "1px solid #EEF3F7" } }, r.premium > 0 ? fmt(r.premium) : "-"),
                        React.createElement("td", { style: { textAlign: "right", padding: 6, color: r.pension > 0 ? BRAND.greenDeep : BRAND.dataBlack, fontWeight: 600, border: "1px solid #EEF3F7" } }, r.pension > 0 ? fmt(r.pension) : "-"),
                        React.createElement("td", { style: { textAlign: "right", padding: 6, color: BRAND.dataBlack, border: "1px solid #EEF3F7" } }, fmt(r.cumPremium)),
                        React.createElement("td", { style: { textAlign: "right", padding: 6, color: BRAND.dataBlack, border: "1px solid #EEF3F7" } }, fmt(r.cumPension)),
                        React.createElement("td", { style: { textAlign: "right", padding: 6, color: BRAND.danger, border: "1px solid #EEF3F7" } }, fmt(r.deathBenefit)),
                        React.createElement("td", { style: { textAlign: "left", padding: 6, color: BRAND.warn, border: "1px solid #EEF3F7" } },
                            isBreakEven ? "จุดคุ้มทุน · " : "",
                            r.note)));
                })))));
    }
